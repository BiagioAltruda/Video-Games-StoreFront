                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-4">
                           ...
                           <input hidden type="text" name="playerId" value="">
                                <submit class="btn btn-primary me-2" id="paymentRedirect" onclick="goToPayment(${JSON.stringify(game).replace(/"/g, '&quot;')})">
...
async function logout(){
    ...
    await fetch(`http://localhost:8080/smoke/accounts/logout`, {
        method: 'POST',
